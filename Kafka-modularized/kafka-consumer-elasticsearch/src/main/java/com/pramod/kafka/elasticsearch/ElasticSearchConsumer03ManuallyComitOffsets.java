...
public class ElasticSearchConsumer03ManuallyComitOffsets {
	...
	public static KafkaConsumer<String, String> createKafkaTwitterConsumer(String topic) {
		...
		kafkaProperties.setProperty(ConsumerConfig.MAX_POLL_RECORDS_CONFIG, "10");
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		Logger logger = LoggerFactory.getLogger(ElasticSearchConsumer03ManuallyComitOffsets.class);
		...
		while (true) {
			...
			ConsumerRecords<String, String> consumerRecords = kafkaTwitterConsumer.poll(Duration.ofMillis(100));// added
																												...
																												// 2.0
																												// onwards
             logger.info("Received "+consumerRecords.count()+" messages"); // This should be max upto 10 as we have set ConsumerConfig.MAX_POLL_RECORDS_CONFIG to  "10"  
